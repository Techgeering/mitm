...
<head>
    ...
    <style>
        ...
        .table {
            border-top: 1px solid black; /* You can adjust the color and thickness as needed */
          }
        .table tbody tr td,
        .table tbody tr th {
...
<body>
    ...
    <div class="container mb-5" style="margin-top: 215px !important;">
        ...
        <table class="table table-hover">
            ...
            <tbody>
				<tr>
				  ...
				  <td><a href="assets/pdf/governingbody.pdf" target="_blank">View</a></td>
				</tr>
				<tr>
				  <th scope="row">2</th>
				  <td>SC/ST Committee</td>
				  <td><a href="assets/pdf/scst.pdf" target="_blank">View</a></td>
				</tr>
				<tr>
				  <th scope="row">3</th>
				  <td>Internship Guideline</td>
				  <td><a href="assets/pdf/internshipguide.pdf" target="_blank">View</a></td>
				</tr>
              <tr>
                <th scope="row">4</th>
                <td>Internal Complain Committee</td>
                <td><a href="assets/pdf/internalcomplaint.pdf" target="_blank">View</a></td>
              </tr>
              <tr>
                <th scope="row">5</th>
                <td>Internal Quality Assurance cell</td>
                <td><a href="assets/pdf/iqac.pdf" target="_blank">View</a></td>
              </tr>
              <tr>
                <th scope="row">6</th>
                <td>Grievance & Redressal Committee</td>
                <td><a href="assets/pdf/grievanceredressal.pdf" target="_blank">View</a></td>
              </tr>
              <tr>
                <th scope="row">7</th>
                <td>Institution Industry Interaction Cell</td>
                <td><a href="assets/pdf/industryinteraction.pdf" target="_blank">View</a></td>
              </tr>
              <tr>
                <th scope="row">8</th>
                <td>Anti-ragging Committee & Anti-ragging Squad</td>
                <td><a href="assets/pdf/anti-ragging (2).pdf" target="_blank">View</a></td>
              </tr>
            </tbody>
          </table>
