    ...
    <!-- <table class="table">
      ...
      <div class="container">
        <div class="container-box">
			<p class="text-center text-danger mb-3 fw-bold popup" >To review our grievance cell, <a href="assets/pdf/grievanceredressal.pdf" target="_blank" >Click here</a>.</p>
            ...
            <form action="#" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="inputGender" name="gender" required style="font-size: 13px;" >
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="inputGrievance" rows="5" name="grievance" required></textarea>
                </div>
