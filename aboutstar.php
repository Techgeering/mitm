...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">About Us</h1>
	   </div>
	</div>
	<div class="container ">
		...
		<div class="row">
			<div class="col-lg-6">
				<h5 class="text-center">Welcome To Biplabini Technology & Industrial Training,Bhubaneswar</h5>
