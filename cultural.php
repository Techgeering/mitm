...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Cultural Events And Sports</h1>
	   </div>
	</div>
	<div class="container content-position">
    <div class="row">
       <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus.jpg" class="campus-img-size" alt="campusimg">
       </div>
       <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus2.jpg" class="campus-img-size" alt="campusimg">
       </div>
       <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus3.jpg" class="campus-img-size" alt="campusimg">
       </div>
       <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus4.jpg" class="campus-img-size" alt="campusimg">
       </div>
       <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus5.jpg" class="campus-img-size" alt="campusimg">
       </div>
        <div class="col-lg-3 campus-img">
       	 <img src="assets/img/campus.jpg" class="campus-img-size" alt="campusimg">
       </div>
