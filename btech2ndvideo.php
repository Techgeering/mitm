...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Btech 2nd Semester video</h1>
	   </div>
	</div>
	<div class="container content-position">
     <div class="row">
     	  <div class="col-lg-4">
     	  	<iframe height="245" class="w-100 rounded-3 shadow mb-2" title="YouTube video player" frameborder="0" src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen></iframe>
     	  </div>
     	  <div class="col-lg-4">
     	  	<iframe height="245" class="w-100 rounded-3 shadow mb-2" title="YouTube video player" frameborder="0" src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen></iframe>
     	  </div>
...
<!-- <iframe width="677" height="381" src="https://www.youtube.com/embed/F65zrW7Jbus" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
<!--- about end-->
