...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Laboratories</h1>
	   </div>
	</div>
	<div class="container ">
		<div class="content-position">
			<table>
			  ...
			  <tr>
			    ...
			    <td>
			    	<p class="lab-design">Computer Centre / Internet Lab</p>
			    	<p class="lab-design">Programming Lab. - I</p>
			    	<p class="lab-design">Computer Organisation Lab.</p>
			    </td>
			  </tr>
			  <tr>
			    <td>Mechanical Engineering</td>
			    <td>
			    	<p class="lab-design">Workshop - I,II & III</p>
			    	<p class="lab-design">Solid Mechanics Lab.</p>
			    	<p class="lab-design">Heat Power Lab.</p>
			    	<p class="lab-design">Fluid Mechanics Lab.</p>
			    	<p class="lab-design">Material Testing And Dynamic Lab.</p>
			    </td>
			  </tr>
			  <tr>
			    <td>Basic Sciences & Humanities</td>
			    <td>
			    	<p class="lab-design">Physics Lab.</p>
			    	<p class="lab-design">Chemistry Lab.</p>
			    	<p class="lab-design">Communication Practice Lab.</p>
			    </td>
			  </tr>
			  <tr>
			    <td>Electrical and Electronics Engineering.</td>
			    <td>
			    	<p class="lab-design">Electronics Circuit Lab.</p>
			    	<p class="lab-design">Microprocessor Lab.</p>
			    </td>
			  </tr>
			  <tr>
			    <td>Civil Engineering</td>
			    <td>
			    	<p class="lab-design">Survey lab</p>
			    	<p class="lab-design">Material lab.</p>
			    	<p class="lab-design">Tansportation lab</p>
			    </td>
			  </tr>
			  <tr>
			    <td>Electronics & Communication Engineering</td>
			    <td>
			    	<p class="lab-design">Power Electronics Lab.</p>
			    	<p class="lab-design">Network & Instrumentation Lab.</p>
			    	<p class="lab-design">CBasic Electrical Engg. & Machine Lab.</p>
			    </td>
			  </tr>
			</table>
		</div>
