...
<div class="carousel-position">
	<div class="heading-bg-img">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Activities Of T & P Cell</h1>
	   </div>
	</div>
	<div class="container content-position">
    <div class="row">
    	<div class="col-lg-4">
    		<img src="assets/img/placement.jpg" class="placement-img" alt="placementimg">
    	</div>
    	<div class="col-lg-8">
    		<h5 class="text-center">Training & Placement Cell</h5>
    		...
    		<h5 class="text-center">Various activities that are undertaken by the Department are as follows:</h5>
