...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Scholarship</h1>
	   </div>
	</div>
	<div class="container ">
		<div class="content-position">
	      ...
	      <div class="col-lg-4">
	      	<div class="scholar-box">
	      		<h5 class="text-center">State Scholarship</h5>
	      		<a href="#"></a>
	      	</div>
	      </div>
	      <div class="col-lg-4">
	      	<div class="scholar-box">
	      		<h5 class="text-center">National Scholarship</h5>
	      		<a href="#"></a>
	      	</div>
	      </div>
	      <div class="col-lg-4">
	      	<div class="scholar-box">
	      		<h5 class="text-center">Medhabruti</h5>
	      		<a href="#"></a>
	      	</div>
	      </div> 
      </div>	
