...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Accreditation</h1>
	   </div>
	</div>
	<div class="container">
		<div class="row pb-2">
		   ...
		   <div class="col-lg-2">
		   	 <img src="assets/img/aicte.png" class="img-fluid" alt="img">
		   </div>
		   <div class="col-lg-4">
		   	 <img src="assets/img/naacimg.png" class="img-fluid" alt="img">
		   </div>
		   <div class="col-lg-4">
		   	<img src="assets/img/deen.jpg" class="img-fluid" alt="img">
		   </div>
		   <div class="col-lg-1"></div>
		</div>
	</div>
