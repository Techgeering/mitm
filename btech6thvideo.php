...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Btech 6th Semester video</h1>
	   </div>
	</div>
	<div class="container content-position">
     <div class="row">
     	  <div class="col-lg-4">
     	  	<iframe height="245" width="362" title="YouTube video player" frameborder="0" src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen></iframe>
     	  </div>
     	  <div class="col-lg-4">
     	  	<iframe height="245" width="362" title="YouTube video player" frameborder="0" src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen></iframe>
     	  </div>
