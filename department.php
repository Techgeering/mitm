...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Department</h1>
	   </div>
	</div>
	<div class="container ">
		<div class="content-position">
			<div class="row">
			  <div class="col-lg-6">
			  	<h5>B.Tech Departments</h5>
			  	<ul class="list-class">
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design"> MECHANICAL ENGINEERING</a>
	     	  		</li>
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design"> ELECTRICAL AND ELECTRONICS ENGINEERING</a>
	     	  		</li>
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">ELECTRONIC AND COMMUNICATION ENGINEERING</a>
	     	  		</li>
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design"> COMPUTER SCIENCE ENGINEERING</a>
	     	  		</li>
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">BASIC SCIENCE AND HUMANITIES</a>
	     	  		</li>
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">CIVIL ENGINEERING</a>
	     	  		</li>
	     	  	</ul>
			  </div>
			  <div class="col-lg-6">
			  	<h5>Diploma Departments</h5>
			  	<ul class="list-class">
	     	  		<li class="text-gap">
	     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">CIVIL ENGINEERING</a>
	     	  		</li>
