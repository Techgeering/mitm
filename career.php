...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Career</h1>
	   </div>
	</div>
	<div class="container ">
    <div class="row">
    	<div class="col-lg-2"></div>
    	<div class="col-lg-8 content-position">
       <form class="contactform" action="" method="post"  id="submit1">
           <div class="form-group career-input-field">
             ...
             <div class="row">
                <div class=" col-md-4 form-group career-input-field">
                ...
                <div class="col-md-4 form-group career-input-field">
                   <label for="subject">Resume<span class="required">*</span></label>
                   <input type="file" name="resume" id="resume" class="p-2 w-100 rounded-3 shadow" required>  
                   <span style="color:red">Only pdf|doc|docx file allowed</span>
                </div>
              </div>
              <div class=" form-group career-input-field">
                  <textarea required="required" aria-required="true" placeholder="Write about you" class="p-2 w-100 rounded-3 shadow" rows="4" cols="30" name="comment" id="comment"></textarea>
              </div>                
              <div class="form-group">
                  <input type="submit" value="Apply" class="mu-post-btn" name="submitbtn" id="submitbtn">
              </div>       
         </form>
       </div>
       <div class="col-lg-2"></div>
