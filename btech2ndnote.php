...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Btech 2nd Semester</h1>
	   </div>
	</div>
	<div class="container content-position">
     <div class="row">
     	  <div class="col-lg-4">
     	  	<ul class="list-class">
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">BEE(1)</a>
     	  		</li>
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">BEE(2)</a>
     	  		</li>
     	  	</ul>
     	  </div>
     	  <div class="col-lg-4">
     	  	<ul class="list-class">
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">Mathematics(1)</a>
     	  		</li>
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">Mathematics(2)</a>
     	  		</li>
     	  	</ul>
     	  </div>
     	  <div class="col-lg-4">
     	  	<ul class="list-class">
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">Physics(1)</a>
     	  		</li>
     	  		<li class="text-gap">
     	  			<i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="javascript:viod(0)" class="text-design">Physics(2)</a>
     	  		</li>
     	  	</ul>
     	  </div>
     </div>
