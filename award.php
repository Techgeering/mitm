...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Award And Certificate</h1>
	   </div>
	</div>
	<div class="container ">
		<div class="content-position">
			<div class="row">
				<div class="col-lg-6">
					<h5 class="text-center">Faculty Development Program</h5>
					...
					<h5 class="text-center">Highlights of Teaching Learning Process</h5>
