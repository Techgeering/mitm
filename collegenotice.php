...
<body>
    ...
    <section class="">
        <div class="container abt-us">
            <h3 class="text-uppercase text-primary text-center about-texthead head-top">College Notice</h3>
            <table class="table table-primary-striped border-top mt-5">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td>21/02/2024</td>
                        <td>Guest Lecture on AI by Dr. Priya Sharma, June 20, 2024, 10 AM, Main Auditorium. Register now!</td>
                        <td><a href="assets/pdf/governingbody.pdf" target="_blank">View</a></td>
                    </tr>
                    <tr>
                        <td>25/03/2024</td>
                        <td>Campus Blood Drive on June 25, 2024, from 9 AM to 3 PM in the Student Center. Your donation can save lives!</td>
                        <td><a href="assets/pdf/governingbody.pdf" target="_blank">View</a></td>
                    </tr>
                    <tr>
                        <td>27/05/2024</td>
                        <td>Library hours extended during finals week: June 10-16, 2024, open from 8 AM to midnight. Study hard and good luck!</td>
                        <td><a href="assets/pdf/governingbody.pdf" target="_blank">View</a></td>
                    </tr>
                    <tr>
                        <td>21/02/2024</td>
