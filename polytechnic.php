            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-content dropdown-menu-box-position" aria-labelledby="DropdownMenu1">
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="about">About Us</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="chairmansays">Chairman
                      Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="principalsays">Principal
                      Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="faculty">Faculties</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="life">Life @ MITM</a>
                  </li>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-content dropdown-menu-box-position" aria-labelledby="DropdownMenu2">
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="ugcourse">UG</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="pgcourse">PG</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-left: -53px">
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    <a class="dropdown-item" href="chairmansays">Chairman Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="principalsays">Principal Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="faculty">Faculties</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="accredation">Accredation</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="life">Life @ MITM</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="ugcourse">UG</a>
                  </li>
                  <!-- <li><hr class="dropdown-divider"></li> -->
                  <li>
                    <a class="dropdown-item" href="pgcourse">PG</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="polytechnic">Polytechnic</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="placementoverview">Overview</a>
                  </li>
                  <!-- <li><hr class="dropdown-divider"></li> -->
                  <li>
                    <a class="dropdown-item" href="placementcompany">Company</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item" style="margin-left: -80px">
