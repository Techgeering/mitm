            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-content dropdown-menu-box-position" aria-labelledby="DropdownMenu1">
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="about.php">About Us</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="chairmansays.php">Chairman
                      Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="principalsays.php">Principal
                      Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="faculty.php">Faculties</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="life.php">Life @ MITM</a>
                  </li>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-content dropdown-menu-box-position" aria-labelledby="DropdownMenu2">
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="ugcourse.php">UG</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover" href="pgcourse.php">PG</a>
                  </li>
                  <li>
                    <a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-left: -53px">
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    <a class="dropdown-item" href="chairmansays.php">Chairman Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="principalsays.php">Principal Speaks</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="faculty.php">Faculties</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="accredation.php">Accredation</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="life.php">Life @ MITM</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="ugcourse.php">UG</a>
                  </li>
                  <!-- <li><hr class="dropdown-divider"></li> -->
                  <li>
                    <a class="dropdown-item" href="pgcourse.php">PG</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="polytechnic.php">Polytechnic</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="https://www.bput.ac.in/exam-info.php">Notice</a>
                  </li>
                  <!-- <li><hr class="dropdown-divider"></li> -->
                  <li>
                    <a class="dropdown-item" href="http://bputexam.in/schedule.aspx">Schedule</a>
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown" style="margin-left: -80px">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="placementoverview.php">Overview</a>
                  </li>
                  <!-- <li><hr class="dropdown-divider"></li> -->
                  <li>
                    <a class="dropdown-item" href="placementcompany.php">Company</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item" style="margin-left: -80px">
  ...
  <div class="d-lg-none d-sm-block" >
    <div class="container py-2 ">
      <div class="ug-detas" style="width: 90%; margin-left: 21px;" >
        <h3 class="active text-center" id="heading12" onclick="showContents('content12', 'heading12')">Polytechnic</h3>
        <div class="line" style="border-right: 4px solid #ff5733;"></div>
      </div>
        ...
        <div class="container">
          <div class="row text-position">
            <div class="col-lg-2">
              ...
              <div>
                <a href="javascript:void(0)" class="link-decoration">NPTEL</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">Swayam</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">DELNET</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">Placement Overview</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">NDL</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">E-SHODHSINDHU</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">ERP</a>
              </div>
              <div>
                <a href="javascript:void(0)" class="link-decoration">Feedback</a>
              </div>
            </div>
            <div class="col-lg-2">
              <h4 class="footer-heading-color">ABOUT US</h4>
              <div>
                <a href="javascript:void(0)" class="link-decoration">Mission & Vision</a>
              </div>
              <div>
            ...
            <div class="col-lg-3">
              ...
              <div>
                <a href="javascript:void(0)" class="link-decoration">Electrical & Electronics Engineering</a>
              </div>
              <div>
            ...
            <div class="col-lg-2">
              ...
              <div>
                <a href="javascript:void(0)" class="link-decoration">Our Career Advisor</a>
              </div>
              <h4 class="footer-heading-color">DIPLOMA</h4>
              <div>
                <a href="javascript:void(0)" class="link-decoration">Anti Ragging Policy</a>
