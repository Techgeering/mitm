...
<head>
	...
	<style>
		.news-events-container {
			...
			position: relative;
			height: 280px;
			box-shadow: 0 0 10px 0 rgba(52, 73, 94, 0.5);
			padding: 10px;
			border-radius: 10px;
			position: relative;
		}
		...
		.news-events-container::before {
			...
			background: linear-gradient(to left,
					rgba(0, 0, 0, 0.7),
					rgba(0, 0, 0, 0.8)),
				url("assets/img/campus.jpg") center/cover no-repeat;
		...
		.courses-position {
			text-align: center;
			/* Center align the text within the courses-position div */
			margin-bottom: 20px;
...
<body>
	...
	<div id="myfirstcaptch" class="first-captcha">
		...
		<div class="admission-enquiry-bg">
			<h6>
				<i class="fa fa-pencil-square-o" aria-hidden="true"></i>Admission
				Enquiry For 2023
			</h6>
		</div>
		<div class="p-3">
			<div class="row">
				<div class="col-12">
					<p class="enquiry-contact-color">
						Contact on +91-xxxxxxxxxx, +91-xxxxxxxxxx or Email:
						admission@xx.com.
					</p>
				</div>
				<div class="col-12">
					<form action="" method="POST" id="contactform" role="form">
						...
						<div class="form-group contact-form-space">
							<select class="form-select book-form inp" name="catego" id="catego">
								...
								<option value="9" class="text-primary">
									B.Tech LE(MECH)
								</option>
							</select>
						</div>
