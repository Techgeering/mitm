		...
		<div class="container ug-box py-2">
			<div class="col-lg-4 col-sm-12 ug-deta">
				<h3 class="active text-center" id="heading1" onclick="showContent('content1', 'heading1')">Computer
					...
					Engineering</h3>
				<div class="line"></div>
				<h3 class="text-center" id="heading6" onclick="showContent('content6', 'heading6')">Computer Science
					Engineering(AI & ML)</h3>
				<div class="line"></div>
			...
			<div class="col-lg-8 col-sm-12 ug-cont">
				...
				<div id="content6" style="display: none;">
					<h4 class="text-uppercase mission-head">Computer Science Engineering(Artificial Intelligence &
						Machine Learning)</h4>
				...
				<div id="content5" style="display: none;">
					...
					<h4><strong>Seat Available:</strong>90</h4>
					<p class="ug-paradt">
