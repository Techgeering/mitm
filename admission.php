...
<body>
					...
					<div class="col-9">
						<div class="top-email-no-position">
							<a href="javascript:void(0)" class="top-nav-text no-border-line"><i
									class="fa fa-phone "></i> +91 7854126988</a>

							<a href="javascript:void(0)" class="top-nav-text email-spacing"><i
									class="fa fa-envelope "></i> info@biplabinitechnology.com</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="top-bgcolor d-block d-lg-none d-md-none d-sm-block">
			<div class="container">
				<div class="row text-center">
					<div class="col-lg-6">
						<a href="javascript:void(0)" class="top-nav-text"><i class="fa fa-phone "></i> +91
							7854126988</a>
					</div>
					<div class="col-lg-6">
						<a href="javascript:void(0)" class="top-nav-text "><i class="fa fa-envelope "></i>
							vcuagfcbf@education.com</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="third-bg-color">
				<div class="container">
					<div class="navbar-nav menu-position justify-content-center text-white">
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu1">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="aboutstar.php">About Star</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="leadership.php">Leadership</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="accredi.php">Accreditation</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="mission.php">Vission & Mission</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="infra.php">Infrastructure</a>
									</li>
								</ul>
							</li>
						</ul>
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								<a class="nav-link active third-menu-color dropdown-toggle" href="#" id="DropdownMenu2"
									role="button" data-bs-toggle="dropdown" aria-expanded="false">Admission</a>
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu2">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="apply.php">Apply for 2023</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="admission.php">Admission Procedure</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="scholarship.php">Scholarship</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="prospective.php">Prospective</a></li>
						...
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu3">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="committee.php">Committee</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="programs.php">Programs</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="department.php">Department</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="cell.php">Cell</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="seminar.php">Seminar & Workshop</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="award.php">Award &
											Certificate</a></li>
								</ul>
							</li>
						</ul>
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								<a class="nav-link active third-menu-color dropdown-toggle" href="#" id="DropdownMenu4"
								...
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu4">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="laboratories.php">Laboratories</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="libraary.php">Libraary</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="medical.php">Medical Facility</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="hostel.php">Hostel</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="transport.php">Transport</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="cultural.php">Cultural Events & Sports</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="canteen.php">Canteen</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="wifi.php">Wifi Campus</a>
									</li>
								</ul>
							</li>
						</ul>
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								<a class="nav-link active third-menu-color dropdown-toggle" href="#" id="DropdownMenu6"
									role="button" data-bs-toggle="dropdown" aria-expanded="false">Lecture Note(s)</a>
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu6">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech1stnote.php">B.Tech 1st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech2ndnote.php">B.Tech 2st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech3rdnote.php">B.Tech 3st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech4thnote.php">B.Tech 4st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech5thnote.php">B.Tech 5st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech6thnote.php">B.Tech 6st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="btech7thnote.php">B.Tech 7st
											Semester</a></li>
								</ul>
							</li>
						</ul>
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								<a class="nav-link active third-menu-color dropdown-toggle" href="#" id="DropdownMenu7"
									role="button" data-bs-toggle="dropdown" aria-expanded="false">Lecture Video(s)</a>
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu7">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech1stvideo.php">B.Tech 1st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech2ndvideo.php">B.Tech 2st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech3rdvideo.php">B.Tech 3st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech4thvideo.php">B.Tech 4st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech5thvideo.php">B.Tech 5st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="btech6thvideo.php">B.Tech 6st Semester</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="btech7thvideo.php">B.Tech 7st
											Semester</a></li>
								</ul>
							</li>
						</ul>
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-box-position" aria-labelledby="DropdownMenu9">
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="Industrial.php">Industrial Training</a></li>
									<li><a class="dropdown-item dropdown-menu-box dropdown-menu-hover"
											href="placement.php">Placement Record</a></li>
									<li><a class="dropdown-item dropdown-menu-hover" href="activities.php">Activities of
											T&P Cell</a></li>
								</ul>
							</li>
						</ul>
		...
		<div class="second-nav-bg d-block d-lg-none d-md-block d-sm-block">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="" style="width: 100%;">
					<a class="navbar-brand" href="#"><img src="assets/img/logos1.png" alt="" class="mob-logo"></a>
					<button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse"
						data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
						aria-expanded="false" aria-label="Toggle navigation"
						style="margin-left: 257px; margin-top: 12px;">
					...
					<div class="navbar-collapse collapse" id="navbarSupportedContent" style="margin-left: -3px;">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin-left: -53px;">
							...
							<li class="nav-item" style="margin-left: -80px;">
								<a class="nav-link" href="contact.php">Csntact US</a>
							</li>
	...
	<!-- <div id="myfirstcaptch" class="first-captcha"> -->
		...
		<div class="p-3">
			<div class="row">
				<div class="col-12">
					<p class="enquiry-contact-color">Contact on +91-9114488727, +91-9114141172 or Email:
						admission@biplabinibbsr.com.</p>
				</div>
				<div class="col-12">

					<form id="mitmenquiry" role="form" class="form-group contact-form-space">
						...
						<div class="form-group contact-form-space">
							<input type="email" placeholder="Enter Email Id" aria-required="true" class="form-control"
								name="email" id="enquiryemail">
						</div>

						<div class="form-group contact-form-space">
							<input type="tel" placeholder="Enter Mobile No" maxlength="10" class="form-control"
								aria-required="true" name="phone" id="enquiryphone">
						</div>

						<div class="form-group contact-form-space">
							<select class="form-select book-form inp" name="course" id="enquirycourse">
						...
						<div class="form-group contact-form-space">
							<textarea aria-required="true" placeholder="Write Your Message" class="form-control"
								max-length="10" rows="2" class="form-control" cols="45" name="message"
								id="enquirymessage"></textarea>
						</div>

						<div class="contact-form-space">
							<div class="col-6 form-group contact-form-space">
								<div id="buttons">
									<a class="btn enquiry-btn " type="submit" name="submit" id="submit"><i
	...
	<div class="carousel-position">
		<div class="heading-bg-img" style="background-image: url(assets/img/footerimg.png);">
			<div class="heading-bg-color">
				<h1 class="heading-text-position">Admission Procedure</h1>
			</div>
		</div>
		<div class="container ">
			<div class="content-position">
				<div class="row">
					<div class="col-lg-7">
						<h5 class="text-center">Admission To 1st Year Degree courses in Engineering & Technology</h5>
						<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Lorem Ipsum is
							simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
							industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
							of type and scrambled it to make a type specimen book. It has survived not only five
							centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
						</p>
						<h5 class="text-center">Admission Criteria</h5>
						<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Lorem Ipsum is
							simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
							industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
							of type and scrambled it to make a type specimen book. It has survived not only five
					...
					<div class="col-lg-5">
						<img src="assets/img/admissionprocess.png" class="placement-img" alt="admissionimg">
					</div>
				</div>
				<div class="col-lg-12 pt-2">
					<h5 class="text-center">Admission to 1st year Diploma Course In Engineering</h5>
					<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> It is a long
						...
						English.</p>
					<h5>DIPLOMA (LE)</h5>
					<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Many desktop
						...
						the like).</p>
					<h5 class="text-center">Admission To 2nd year Degree courses in Engineering/Technology(Lateral
						Entry)</h5>
					<h5>B-TECH (LE)</h5>
					<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> It is a long
						established fact that a reader will be distracted by the readable content of a page when looking
						at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution
						of letters, as opposed to using 'Content here, content here', making it look like readable
						English. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum"
					...
					<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Many desktop
						...
						search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions
						have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and
						the like). Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et
					...
					<h5 class="text-center">For more information regarding Admission</h5>
					<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> It is a long
						established fact that a reader will be distracted by the readable content of a page when looking
						at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution
						of letters, as opposed to using 'Content here, content here', making it look like readable
	...
	<script src="assets/js/allpage.js?v=1.2"></script>
</body>
