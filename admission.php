...
<div class="carousel-position">
    ...
    <div class="col-lg-12 pt-2">
    	...
    	<h5>DIPLOMA (LE)</h5>
    	<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
    	<h5 class="text-center">Admission To 2nd year Degree courses in Engineering/Technology(Lateral Entry)</h5>
    	<h5>B-TECH (LE)</h5>
    	<p class="para-size"><i class="fa fa-angle-double-right" aria-hidden="true"></i> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. </p>
    	<h5>B. SC. (LE)</h5>
