...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Infrastructure</h1>
	   </div>
	</div>
	<div class="container">
		<div class="content-position">
			<div class="row">
				...
				<div class="col-lg-6">
					<img src="assets/img/headingbgimg.png" class="vission-img-box">
				</div>
				<div class="col-lg-12">
					<h5>Facilities Provided For Campus Interview:</h5>
