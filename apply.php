...
<div class="carousel-position">
	...
	<div class="container ">
	    <div class="content-position">
            <div class="row">
                <div class="col-lg-6">
                	<img src="assets/img/apply.jfif" class="img-fluid about-content-img" alt="applyimg">
                </div>
                <div class="col-lg-6">
                	<h5 class="text-center">Admission Enquiry :</h5>
                	<form class="contactform" action="" method="post"  id="submit">
                		<div class="row">
                			<div class="col-lg-12">
                			    <div class="form-group career-input-field">
                                    <input type="text" required="required" placeholder="Full Name" class="p-2 w-100 rounded-3 shadow" value="" id="author" name="author">
                                </div>
                			</div>
                			<div class="col-lg-6">
                			    <div class="form-group career-input-field">
                                    <input type="email" required="required" placeholder="Email Id" class="p-2 w-100 rounded-3 shadow" aria-required="true" value="" name="email" id="email">
                                </div>
                			</div>
                			<div class="col-lg-6">
                				<div class="form-group career-input-field">
                                    <input type="tel" required="required" placeholder="Phone" maxlength="10" class="p-2 w-100 rounded-3 shadow" aria-required="true" value="" name="pno" id="pno">
                                </div>
                			</div>
                			<div class="col-lg-6">
        						<select name="courses" id="courses" class="p-2 w-100 rounded-3 shadow career-input-field">
        							<option value="courses1">courses1</option>
        						    <option value="courses2">courses2</option>
        							<option value="courses3">courses3</option>
        							<option value="courses4">courses4</option>
        						</select>	
                			</div>
                			<div class="col-lg-6">
                			    <div class="form-group career-input-field">
                                    <input type="address" required="required" placeholder="Location" class="p-2 w-100 rounded-3 shadow" aria-required="true" value="" name="location" id="location">
                                </div>
                			</div>
                			<div class="col-lg-12">
                				<div class=" form-group career-input-field">
                                    <textarea required="required" aria-required="true" placeholder="Message" class="p-2 w-100 rounded-3 shadow" rows="2" cols="30" name="comment" id="comment"></textarea>
                                </div> 
                			</div>
        					<div class="col-lg-6">
