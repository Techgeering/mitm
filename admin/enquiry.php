            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="enquiry" class="nav-item nav-link active">
                        ...
                        <a href="news-event" class="nav-item nav-link">
                            <i class="bi bi-newspaper me-2"></i> News and Event
                        </a>
                        <a href="notice" class="nav-item nav-link">
