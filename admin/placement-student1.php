...
if ($form === NULL) {
    ...
    <head>
        <meta charset="utf-8">
        <title>MITM | Placement Student</title>
        ...
        <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        if ($collage === '1') {
                            ...
                            echo '<a href="placement-student1" class="nav-item nav-link active"><i
                                class="fas fa-briefcase"></i>Placement Std</a>';
                            ...
                            echo '<a href="placement-student1.php" class="nav-item nav-link active"><i
            ...
            <div class="content">
                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <table id="example1" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <?php include 'db.php';
                                        $sql = "SELECT * FROM mitm_campus_placement where college_type= '$collage' ORDER BY id DESC";
                                        ...
                                        while ($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td class=text-center><img
                                                        src="upload/studentplacement/<?php echo $row['image']; ?>" width="50"
                                                        height="50">
                                                </td>
                ...
                if (isset($_POST['addplacement'])) {
                    ...
                    $upload_dir = "upload/studentplacement/";
                    ...
                    $sql = "INSERT INTO mitm_campus_placement(image,year,branch,student_name,company_name ,status,college_type) 
             VALUES('$new_file_name','$year','$branch','$studentname','$companyname','1','$collage')";
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Upload Placement Student</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="branch" id="branch" class="form-control">
                                                ...
                                                <option value="Master Of Business Application">Master Of Business
                                                    Application</option>
                                                <option value="Master Of Computer Application">Master Of Computer
                                                    Application</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="modal fade" data-bs-backdrop="static" id="updateplacement">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Update Placement Student</h4>
                ...
                <script>
                    //member image
                    $("#zxy").attr("src", "assets/img/no-image.png");
