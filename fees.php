...
<div class="carousel-position">
	<div class="heading-bg-img" style="background-image: url(assets/img/headingbgimg.png);">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Fees</h1>
	   </div>
	</div>
	<div class="container ">
		<div class="content-position">
            <div class="row">
                <div class="col-lg-6">
        	        <img src="assets/img/fees.jfif" class="img-fluid about-content-img" alt="applyimg">
                </div>
                <div class="col-lg-6">
        	        <h5 class="text-center">Fee structure for student :</h5>
        	        <form class="contactform" action="" method="post"  id="submit">
        		        <div class="row">
							...
							<div class="col-lg-12">
							    <button type="submit" class="btn enquiry-btn w-100"><i class="fa fa-paper-plane" aria-hidden="true"></i>  Submit</button>
							</div>
        		        </div>
        	        </form>
                </div>
