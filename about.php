		...
		<div class="fixed-top top-z-index">
			<div class="top-bgcolor d-none d-lg-block d-md-block d-sm-none">
				<div class="container">
					<div class="row">
						<div class="col-3">
							<a href="https://www.facebook.com/share/cEx3aUwFEbeQ4EUQ/?mibextid=qi2Omg(0)" class="top-icon"><i class="fa fa-facebook top-fa-icon"
		...
		<div class="container abt-us">
		  ...
		  <div class="row">
			<div class="col-12 col-sm-6 col-md-6 order-md-1 order-2">
			  <img src="assets/img/birla.jpg" alt="Birla Image" class="img-fluid" style="margin-top: 3px; margin-bottom: 9px;">
			</div>
			<div class="col-12 col-sm-6 col-md-6 order-md-2 order-1">
			  <h5>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab doloribus natus sint assumenda rem similique laboriosam, incidunt unde, non sed necessitatibus voluptates? Magni labore iure est libero fugiat cupiditate ab? Lorem, ipsum dolor sit
				amet consectetur adipisicing elit. Fugiat quo, accusantium, unde cupiditate a minima assumenda dolores tempore, ex voluptatum repellendus saepe? Non provident ipsam, ea nesciunt commodi inventore! Ipsam. Lorem ipsum dolor sit amet consectetur
				adipisicing elit. Fuga sit expedita vitae exercitationem officiis, praesentium laudantium! Eaque suscipit quo porro voluptas earum, odit ipsam ea vel qui, repudiandae a maxime?
			  </h5>
			</div>
		  </div>
		</div>
