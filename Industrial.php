...
<div class="carousel-position">
	<div class="heading-bg-img">
		<div class="heading-bg-color">
		   <h1 class="heading-text-position">Industrial Training</h1>
	   </div>
	</div>
	<div class="container content-position">
    <div class="row">
    	<div class="col-lg-6">
    		<h5 class="text-center">Industrial Tour</h5>
    		<p class="para-size pt-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
    	</div>
    	<div class="col-lg-6">
    		<img src="assets/img/industry.jpg" class="placement-img" alt="Industrialimg">
    	</div>
    </div>
	</div>
</div>
